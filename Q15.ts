...
// let dinnerGuestss: string[] = ["Haris", "Khan", "lala"];
...
// let newGuest = "Hariq";
// let indexOfCanceledGuest = dinnerGuestss.indexOf(guestWhoCantMakeIt);

// if (indexOfCanceledGuest !== -1) {
//     dinnerGuestss[indexOfCanceledGuest] = newGuest;
// }


// dinnerGuestss.forEach((guest) => {
